"""
Containers following the XEP-6 wallet standard.
"""
...
from epicchain.core import interfaces, cryptography
from epicchain.contracts import contract, utils as contractutils
from epicchain.wallet import account
from epicchain.wallet import scrypt_parameters as scrypt
...
class Wallet(interfaces.IJson):
    ...
    def save(self):
        ...
        See Also:
            [DiskWallet](#epicchain.wallet.wallet.DiskWallet)
        """
        pass
