...
def address_to_script_hash(address: EpicChainAddress) -> types.UInt160:
    """
...
def is_valid_address(address: EpicChainAddress) -> bool:
    """
...
def validate_address(address: EpicChainAddress, address_version: int = 0x35) -> None:
    """
