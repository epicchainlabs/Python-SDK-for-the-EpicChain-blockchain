...
class ISerializable(abc.ABC):
    """
    An interface like class supporting EpicChain's network serialization protocol.
    """
...
class BinaryReader(object):
    ...
    def read_var_int(self, max: int = sys.maxsize) -> int:
        ...
        The EpicChain network protocol supports encoded length indicating for saving space.
        See: :ref:`library-core-variable-length-encoding`

        See also:
            * :func:`~epicchain.core.serialization.BinaryWriter.write_var_int`
            * :func:`~epicchain.core.serialization.BinaryReader.read_var_string`
            * :func:`~epicchain.core.serialization.BinaryReader.read_var_bytes`
    ...
    def read_var_bytes(self, max: int = sys.maxsize) -> bytes:
        ...
        See also:
            * :func:`~epicchain.core.serialization.BinaryWriter.write_var_bytes`
            * :func:`~epicchain.core.serialization.BinaryReader.read_var_int`
            * :func:`~epicchain.core.serialization.BinaryReader.read_var_string`
    ...
    def read_var_string(self, max: int = sys.maxsize) -> str:
        ...
        See also:
            * :func:`~epicchain.core.serialization.BinaryWriter.write_var_string`
            * :func:`~epicchain.core.serialization.BinaryReader.read_var_int`
            * :func:`~epicchain.core.serialization.BinaryReader.read_var_bytes`
...
class BinaryWriter(object):
    ...
    def write_var_bytes(self, value: bytes, endian: str = "<") -> int:
        ...
        The EpicChain network protocol supports encoded length indicating for saving space. See
