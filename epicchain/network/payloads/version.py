...
import datetime
from epicchain.core import Size as s, serialization, utils
from epicchain.network import capabilities
from epicchain import settings
...
class VersionPayload(serialization.ISerializable):
    ...
    def __init__(
        ...
        Args:
            ...
            user_agent: node user agent description. e.g. "epicchain-PYTHON-V001". Max 1024 bytes.
            capabilities: a list of services a node offers.
        """

        #: A network id. Differs for EpicChain's Mainnet (use 5195086) and Testnet (use 1951352142).
        #:
        ...
        self.nonce = nonce
        #: A node client description i.e. "EPICCHAIN-RAPTOR-V001"
