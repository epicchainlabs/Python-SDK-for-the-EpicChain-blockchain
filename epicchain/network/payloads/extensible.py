...
import hashlib
from epicchain.core import types, serialization, Size as s, utils
from epicchain.network.payloads import inventory, verification
...
class ExtensiblePayload(inventory.IInventory):
    ...
    # Comes from epicchain.network.message.Message.PAYLOAD_MAX_SIZE but wanted to break the import cycle
