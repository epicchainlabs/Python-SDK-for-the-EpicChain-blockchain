...
from epicchain.network.payloads import block
from epicchain.network.convenience import nodemanager, requestinfo, flightinfo
from epicchain.core import msgrouter
from epicchain import network_logger as logger, singleton
...
class SyncManager(singleton._Singleton):
    ...
    #: :attr:`~epicchain.network.payloads.block.GetBlockByIndexPayload.MAX_BLOCKS_COUNT`.
