"""
EpicChain Executable Format.
"""
from __future__ import annotations
import base64
import hashlib
from collections.abc import Sequence
from epicchain.core import serialization, types, Size as s, utils as coreutils, interfaces
from epicchain.contracts import callflags
from typing import Optional


class XEF(serialization.ISerializable, interfaces.IJson):
    """
    EpicChain Executable Format container.
    """
    ...
    def __init__(
        ...
        # this is intentional, because XPP computes the initial checksum by serializing itself while checksum is 0
    ...
    def compute_checksum(self) -> int:
        """
        Compute the checksum of the XEF file.
        """
    ...
    def from_file(cls, path: str):
        ...
        Raises:
            ...
            ValueError: if the file is not a valid XEF.
        """
        with open(path, "rb") as f:
            try:
                return cls.deserialize_from_bytes(f.read())
            except ValueError as e:
                raise ValueError(f"Failed XEF file validation with: {e}")
