"""
XEP-15 contract manifest classes for describing smart contract access control.
"""
...
from epicchain.contracts import utils as contractutils, abi
from epicchain.core import serialization, types, cryptography, utils as coreutils, interfaces
...
class ContractPermission(interfaces.IJson):
    ...
    def to_json(self) -> dict:
        ...
        # because XPP C# returns a string from "method" instead of sticking to a standard interface
...
class ContractPermissionDescriptor(interfaces.IJson):
    ...
    def to_json(self) -> dict:
        ...
        Convert object into JSON representation.
        """
        # EpicChain C# deviates here. They return a string
...
class ContractManifest(serialization.ISerializable, interfaces.IJson):
    ...
    def __init__(self, name: Optional[str] = None):
        ...
        #: The list of XEP standards supported e.g. "XEP-3"
        self.supported_standards: list[str] = []

        #: For technical details of ABI, please refer to XEP-14: EpicChainContract ABI.
